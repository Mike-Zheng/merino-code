...
export function drawVerticalLeftLineIcon(
  ctx: CanvasRenderingContext2D,
  left: number,
  top: number,
  styleOverride: any,
...
export function drawVerticalRightLineIcon(
  ctx: CanvasRenderingContext2D,
  left: number,
  top: number,
  styleOverride: any,
...
export function drawRotateIcon(
  ...
  function draw(startAngle: number, endAngle: number) {
    ...
    ctx.beginPath();
    const arrowTop = getPointOnCircle(
      center as fabric.Point,
      radius,
      endAngle + 0.4
    );
    ...
    const arrowLeft = getPointOnCircle(
      center as fabric.Point,
      radius - arrowWidth,
      endAngle
    );
    ...
    const arrowRight = getPointOnCircle(
      center as fabric.Point,
      radius + arrowWidth,
      endAngle
    );
...
export function drawAngleIcon(
  ...
  const centerLeft = center.x - center.w / 2,
    centerTop = center.y - center.h / 2;
