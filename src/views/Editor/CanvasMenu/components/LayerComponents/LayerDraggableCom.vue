<template>
  <div class="layer-content">
    <div
      ...
      :class="
        handleElement && handleElement.id === element.id ? 'layer-active' : ''
      "
    ...
    >
      <div class="element-info">
        ...
        <div
          ...
          v-if="
            ...
            element.type === ElementNames.TEXT
          "
        >
          {{ (element as TextboxElement).text }}
        </div>
        <div class="element-layer" v-if="element.layer">
          {{ element.layer }}
        </div>
      </div>
      ...
      <div class="element-handler">
        ...
        <div
          v-if="
            element.type.toLowerCase() === ElementNames.TEXTBOX ||
            element.type.toLowerCase() === ElementNames.ITEXT
          "
        >
          <el-tooltip
            placement="top"
