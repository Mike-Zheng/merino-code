  ...
  <div class="multi-style-panel">
    ...
    <div class="row">
      ...
      <el-popover trigger="click" width="265">
        ...
        <ColorPicker
          ...
          @update:modelValue="(value: string) => updateFillColor(value)"
        />
      </el-popover>
    </div>
    ...
    <div class="row">
      ...
      <el-popover trigger="click" width="265">
        ...
        <ColorPicker
          ...
          @update:modelValue="(value: string) => updateOutlineColor(value)"
        />
      </el-popover>
    </div>
    <div class="row">
    ...
    <div v-if="hasTextbox && handleTextboxElement">
      <el-row>
        ...
        <el-col :span="12">
          <el-select
            v-model="handleTextboxElement.fontSize"
...
const { activeElementList, canvasObject, systemFonts } =
...
const handleTextboxElement = computed(() => {
  ...
  const textboxElements = handleGroupElement.value._objects.filter(
    (obj) => obj.type === ElementNames.TEXTBOX
  );
