...
export default {
  ...
  message: {
    ...
    barCode: "Bar code",
    barCodeTips:
      "Quickly generate one-dimensional codes, supporting 4 types of coding",
    QRCode: "QR code",
    QRCodeTips: "Quickly generate QR codes, supporting 13 styles",
    AICutoutImage: "Cut img",
    AICutoutImageTips:
      "Utilizing AI technology to achieve intelligent recognition",
    ColorFillImage: "Image fill color",
    ColorFillImageTips:
      "Image color filling, commonly used to change background color",
